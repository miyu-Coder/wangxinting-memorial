...
app.use('/api/checkin', require('./server/routes/checkin')(db));
app.use('/api/flower', require('./server/routes/flower')(db));
app.use('/api/quiz', require('./server/routes/quiz')(db));
app.use('/api/messages', require('./server/routes/messages')(db));
app.use('/api', require('./server/routes/stats')(db));
app.use('/api', require('./server/routes/admin')(db));

app.get('/admin', function(req, res) {
  res.sendFile(path.join(__dirname, 'server', 'admin', 'index.html'), function(err) {
    if (err) {
